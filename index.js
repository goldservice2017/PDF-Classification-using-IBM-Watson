...
app.post('/parse', (req, res, err) => {
  ...
  upload(req, res, (err) => {
    ...
    var url = 'https://gateway.watsonplatform.net/compare-and-comply-experimental/api/v1/parse?version=2017-10-30&subdomain=contract&analyze=true&categorize=true'
